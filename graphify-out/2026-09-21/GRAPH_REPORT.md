...
## Summary
- 3465 nodes · 6911 edges · 357 communities (202 shown, 155 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 122 edges (avg confidence: 0.87)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `005ce7ba`
...
## Communities (357 total, 155 thin omitted)
...
Cohesion: 0.08
Nodes (59): lucide-react, react, ref_react_dom_client, AdminLayout(), App(), ResidentAvatar(), ResidentAvatarProps, ToastNotification() (+51 more)
...
### Community 20 - "workflow-migration-geometry.mjs"
Cohesion: 0.38
...
### Community 28 - "adaptive-reader-layout.test.mjs"
Cohesion: 0.23
...
### Community 43 - "guided-views.test.mjs"
Cohesion: 0.25
...
### Community 47 - "story-follow-camera.test.mjs"
Cohesion: 0.25
...
### Community 74 - "architecture-compare-recovery.test.mjs"
Cohesion: 0.22
...
Cohesion: 0.06
Nodes (29): assertFontCss(), assertOfflineArtifact(), EXPECTED_FACES, FONT_LICENSE, inspectDocuments(), cssResources(), visit(), evaluate() (+21 more)
...
### Community 101 - "site-language-continuity.test.mjs"
Cohesion: 0.04
Nodes (29): CASES, __dirname, skillRoot, template, tmp, __dirname, repoRoot, skillRoot (+21 more)

### Community 102 - "generate-brand-marks.mjs"
Cohesion: 0.18
...
### Community 125 - "ref_node_fs"
Cohesion: 0.06
Nodes (20): originalRmSync, CASES, __dirname, skillRoot, tmp, CASES, __dirname, skillRoot (+12 more)
...
Cohesion: 0.15
Nodes (19): find_or_create_folder(), get_access_token(), get_photo(), load_gdrive_config(), main(), register_in_oracle(), upload_file_to_drive(), get_connection() (+11 more)

### Community 141 - "cli.test.mjs"
Cohesion: 0.22
...
### Community 153 - "reach-share-card.test.mjs"
Cohesion: 0.25
Nodes (5): CASES, __dirname, repoRoot, skillRoot, tmp
...
Cohesion: 0.08
Nodes (17): launchTarget(), openArtifact(), OPENERS, openLoopbackUrl(), workflow, CASES, __dirname, skillRoot (+9 more)

### Community 165 - "toCol"
Cohesion: 0.50
Nodes (4): toCol, maximum, minimum, type

### Community 166 - "ref_node_child_process"
Cohesion: 0.03
Nodes (44): __dirname, outputRoot, skillRoot, TARGETS, CASES, __dirname, NODE_COLLECTION, skillRoot (+36 more)
...
### Community 169 - "ref_node_url"
Cohesion: 0.03
Nodes (62): authoringContract, __dirname, schemaReadme, skill, skillRoot, __dirname, skillRoot, here (+54 more)
...
## Knowledge Gaps
- **1291 isolated node(s):** `__dirname`, `skillRoot`, `TYPES`, `COMPOSITION_CHECKS`, `CHECK_FIXES` (+1286 more)
...
- **Why does `compileWorkflowInternal()` connect `compileWorkflowInternal` to `render-dataflow.mjs`, `geometry.mjs`, `render-architecture.mjs`, `textUnits`, `render-lifecycle.mjs`, `cli.mjs`, `workflow-migration-geometry.mjs`, `asArray`, `validateSchema`, `workflow-compiler.mjs`?**
